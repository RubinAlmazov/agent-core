...
public class FakePortfolioService implements PortfolioService {
    ...
    public PortfolioState getPortfolioState() {
        List<Position> positions = List.of(
                new Position("GAZP", new BigDecimal("10"), new BigDecimal("300.00"), new BigDecimal("312.00")),
                new Position("SBER", new BigDecimal("20"), new BigDecimal("170.00"), new BigDecimal("168.50"))
        );
